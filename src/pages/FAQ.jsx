      ...
      <div className="max-w-4xl mx-auto">
          ...
          {currentFaqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-4 flex justify-between items-center text-left hover:bg-white/5 transition-all duration-300"
              >
                <span 
                  className="text-white font-semibold text-lg pr-4"
                  style={{ fontFamily: '"Oxanium", sans-serif' }}
                >
                  {faq.question}
                </span>
        ...
        <div className="mt-16 text-center">
          ...
          <a
            ...
            className="inline-block bg-[#FF6B35] hover:bg-[#FF8C5A] text-white px-8 py-3 rounded-full font-bold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
            style={{ fontFamily: '"Oxanium", sans-serif' }}
          >
            Contact Us
          </a>
