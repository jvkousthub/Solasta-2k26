...
const lanyard = 'https://raw.githubusercontent.com/jvkousthub/Solasta-2k26/master/src/assets/lanyard.webp';
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, cardModel }) {
  const band = useRef(),
    fixed = useRef(),
    j1 = useRef(),
    j2 = useRef(),
